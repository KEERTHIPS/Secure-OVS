...
public partial class User_VotingStatus : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      // Chart1.Series[0].XValueMember = "candid";
       ...
       // DataTable dt = db.selectquery("select  (c.name) as name,v.candid,count(v.candid)as count from voting v join candidates c on v.candid = c.cid GROUP BY  v.candid, c.name");
